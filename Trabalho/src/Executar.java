...
public class Executar {
	...
	public	static	String[] acoesIniciais={"Inserir Nó", "Excluir No", "Alterar No", "Apresentar Árvore", "Mostrar Pre-Ordem", "Mostrar Ordem", "Mostrar Pos-Ordem", "Sair"};
	...
	public static void main(String[] args) {
		...
		do {
			...
			switch(opcao)
			{
				...
				case	7:	mensagem = "Deseja realmente sair?";
